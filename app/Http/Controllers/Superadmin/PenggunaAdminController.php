...
class PenggunaAdminController extends Controller
{
    public function index()
    {
        ...
        ->distinct()->get();
        return view('superadmin.pengguna.admin.admin')->with('users',$users);        
        // return $users;
    ...
    public function store(Request $request){
        ...
        return redirect('superadmin/pengguna/user-admin')->with('status', 'Berhasil Menambahkan Data Admin');
    }
    ...
    public function reset(Request $request,$id=0){
        ...
        if($id == Auth()->user()->id){
            ...
            return redirect('superadmin/pengguna/user-admin')->with('status','Tidak dapat reset password diri sendiri!');
        }
        else{
        ...
        Session::flash('statuscode','success');
        return redirect('superadmin/pengguna/user-admin')->with('status', 'Berhasil Reset Password Admin');
        }
    }
    ...
    public function delete($id)
    {
        ...
        Session::flash('statuscode','success');
        return redirect('superadmin/pengguna/user-admin')->with('status', 'Berhasil Hapus Admin');
    }
    }
}
