...
class DataPeriodeController extends Controller
{
    public function index()
    {
        ...
        $beritas = Berita::all();
       return view('superadmin.periode.periode',compact('periodes','beritas'));     
    }
    ...
    public function store(Request $request){
        ...
        if(count($a)>0){
            ...
            return redirect('superadmin/periode')->with('status', 'Gagal Menambahkan Data Periode');
        }else{
...
Kami dari Admin Asistensi memberitahukan kepada seluruh calon Asisten Praktikum Semester Genap Tahun Akademik".$request->input('thn_ajaran').", ingin menginformasikan bahwa sudah ada daftar nama Asisten Praktikum Tahun Ajaran ini. Untuk lebih lengkapnya silahkan login dengan akun masing-masing.";
    ...
    Session::flash('statuscode','success');
        return redirect('superadmin/periode')->with('status', 'Berhasil Menambahkan Data Periode');
    }
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('superadmin.periode.edit', compact('periodes'));
    }
...
Daftarkan segera dan jadilah bagian dari kami.";
        ...
        if($beritas->judul != $judul || $beritas->judul == $judul){
            ...
            Session::flash('statuscode','error');
            return redirect('superadmin/periode')->with('status', 'Gagal Merubah Data Periode!'); 
        }
...
Kami dari Admin Asistensi memberitahukan kepada seluruh calon Asisten Praktikum Semester Genap Tahun Akademik".$request->input('thn_ajaran').", ingin menginformasikan bahwa sudah ada daftar nama Asisten Praktikum Tahun Ajaran ini. Untuk lebih lengkapnya silahkan login dengan akun masing-masing.";
        ...
        Session::flash('statuscode','success');
        return redirect('superadmin/periode')->with('status','Data Periode Berhasil Diubah');
    }
    ...
    public function delete($id){
        ...
        Session::flash('statuscode','success');
        return redirect('superadmin/periode')->with('status', 'Berhasil Hapus Periode');
