...
class DataMatkulController extends Controller
{
    ...
    {
        $matkuls = Matkul::all();
        return view('superadmin.matkul.matkul',compact('matkuls'));        
    }
    ...
    public function store(Request $request){
        ...
        return redirect('superadmin/master/matkul')->with('status', 'Gagal Menambahkan Data Matakuliah');
        }else{
        $matkuls = new Matkul;
        ...
        return redirect('superadmin/master/matkul')->with('status', 'Berhasil Menambahkan Data Matakuliah');
        }
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('superadmin.matkul.edit', compact('matkuls'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash('statuscode','success');
        return redirect('superadmin/master/matkul')->with('status','Data Matakuliah Berhasil Diubah');
    }
    ...
    public function delete($id){
        ...
        Session::flash('statuscode','success');
        return redirect('superadmin/master/matkul')->with('status', 'Berhasil Hapus Matakuliah');
