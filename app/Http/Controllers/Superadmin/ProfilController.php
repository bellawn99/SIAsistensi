...
class ProfilController extends Controller
{
    ...
    public function __construct()
  {
    ...
    public function index()
    {
        ...
        return view('superadmin.profil.profil',compact('profils'));
    }
    ...
    public function editFoto(Request $request, $id)
    {
        ...
        return view('superadmin.profil.edit-foto', compact('users'));
    }
    ...
    public function updateFoto(Request $request, $id)
    {
        ...
        return redirect('superadmin/profil')->with('status','Avatar berhasil di ubah');
    }
    ...
    public function editData(Request $request, $id)
    {
        ...
        return view('superadmin.profil.edit-data',compact('users','admins'));
    }
    ...
    public function updateData(Request $request, $id)
    {
        ...
        if($users->update()){
            ...
            if($admins->update()){
                ...
                Session::flash('statuscode','success');
                return redirect('superadmin/profil')->with('status','Data diri berhasil di ubah');
            }
        }

        Session::flash('statuscode','error');
        return redirect('superadmin/profil')->with('status','Data diri gagal di ubah');
    }
