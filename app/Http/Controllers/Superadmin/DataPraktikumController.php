...
class DataPraktikumController extends Controller
{
    public function index()
    {
       ...
       return view('superadmin.praktikum.praktikum',compact('praktikums','kelass','idKelas','matkuls','idMatkul','dosens','idDosen','jadwals','idJadwal','ruangans','idRuangan','semesters'));        
    }
    ...
    public function store(Request $request){
        ...
        return redirect('superadmin/praktikum')->with('status', 'Gagal Menambahkan Data Praktikum');
        }
        else{
        ...
        return redirect('superadmin/praktikum')->with('status', 'Berhasil Menambahkan Data Praktikum');
        }
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('superadmin.praktikum.edit', compact('praktikums','kelass','idKelas','matkuls','idMatkul','dosens','idDosen','jadwals','idJadwal','ruangans','idRuangan','semesters'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(count($b) > 0 || count($a) > 0){
            Session::flash('statuscode','error');
        return redirect('superadmin/praktikum')->with('status', 'Gagal Mengubah Data Praktikum');
        }
        else{
        ...
        Session::flash('statuscode','success');
        return redirect('superadmin/praktikum')->with('status','Data Praktikum Berhasil Diubah');
        }
    }
    ...
    public function delete($id){
        ...
        Session::flash('statuscode','success');
        return redirect('superadmin/praktikum')->with('status', 'Berhasil Hapus Praktikum');
