...
class DataSemesterController extends Controller
{
    public function index()
    {
       ...
       return view('superadmin.semester.semester',compact('semesters'));        
    }
    ...
    public function csv_import()
    {
        ...
        Session::flash('statuscode','success');
            return redirect('superadmin/master/semester')->with('status','Berhasil Menambahkan Data Semester');
    }
    ...
    public function store(Request $request){
        ...
        return redirect('superadmin/master/semester')->with('status', 'Gagal Menambahkan Data Semester!');
        }else{
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('superadmin.semester.edit', compact('semesters'));
    }
