...
@section('title')
	<a href="{{url('superadmin/master/jadwal')}}" style="color:black; text-decoration:none">Master Jadwal</a>
@endsection
                      ...
                      <tbody>
                        <tr>
                          @foreach ($jadwals as $item)
                            ...
                            <td>
                            <a href="{{route('superadmin.master.editJadwal',$item['id'])}}">
...
<div class="modal fade" id="tambahJadwal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="forms-sample" style="{margin:0 auto;}" data-toggle="validator" action="{{ route('superadmin.store.jadwal') }}" method="post">
                    {{csrf_field()}}
                    {{ method_field('POST') }}
...
<div class="modal fade" id="importJadwal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="{{ route('superadmin.import.jadwal') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
