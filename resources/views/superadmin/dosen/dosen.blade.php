...
@section('title')
	<a href="{{url('superadmin/master/dosen')}}" style="color:black; text-decoration:none">Master Dosen</a>
@endsection
                      ...
                      <tbody>
                        <tr>
                          @foreach ($dosens as $item)
                            ...
                            <td>{{ $item->nama }}</td>
                            <td>
                            <a href="{{route('superadmin.master.editDosen',$item['id'])}}">
...
<div class="modal fade" id="tambahDosen" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="forms-sample" style="{margin:0 auto;}" data-toggle="validator" action="{{ route('superadmin.store.dosen') }}" method="post">
                    {{csrf_field()}}
                    {{ method_field('POST') }}
...
<div class="modal fade" id="importDosen" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="{{ route('superadmin.import.dosen') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
