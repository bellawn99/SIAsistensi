...
@section('title')
<a href="{{url('superadmin/master/dosen')}}" style="color:black; text-decoration:none">Master Dosen</a> / <a style="color:grey; text-decoration:none">Ubah Dosen</a>
@endsection
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  @endif
                    ...
                    <form class="forms-sample" method="post" data-toggle="validator" action="{{url('admin/master/dosen/update/'.$dosens->id)}}">
                    {{ csrf_field() }} 
                    {{ method_field('PUT') }}
                      ...
                      <button type="button" class="btn btn-light btn-sm"  onclick="location.href='{{url('admin/master/dosen')}}'">Batal</button>
                    </form>
                  </div>
                </div>
              </div>
