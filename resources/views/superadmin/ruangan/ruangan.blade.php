...
@section('title')
	<a href="{{url('superadmin/master/ruangan')}}" style="color:black; text-decoration:none">Master Ruangan</a>
@endsection
                      ...
                      <tbody>
                        <tr>
                          @foreach ($ruangans as $item)
                            ...
                            <td>
                            <a href="{{route('superadmin.master.editRuangan',$item['id'])}}">
...
<div class="modal fade" id="tambahRuangan" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="forms-sample" style="{margin:0 auto;}" data-toggle="validator" action="{{ route('superadmin.store.ruangan') }}" method="post">
                    {{csrf_field()}}
                    {{ method_field('POST') }}
...
<div class="modal fade" id="importRuangan" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="{{ route('superadmin.import.ruangan') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
