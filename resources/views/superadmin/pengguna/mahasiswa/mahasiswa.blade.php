...
@section('title')
	<a href="{{url('superadmin/pengguna/user-mahasiswa')}}" style="color:black; text-decoration:none">Mahasiswa</a>
@endsection
                      ...
                      <tbody>
                        <tr>
                          @foreach ($users as $item)
                            ...
                            <td>
                            <a href="{{route('superadmin.pengguna.detail',$item->id)}}">
...
<div class="modal fade" id="ubah{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form class="forms-sample" style="{margin:0 auto;}" data-toggle="validator" action="{{ route('superadmin.reset.mahasiswa') }}" method="post">
        {{csrf_field()}}
        {{ method_field('POST') }}
...
<div class="modal fade" id="importMhs" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="{{ route('superadmin.import.pengguna.mhs') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
...
<div class="modal fade" id="tambahMhs" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form class="forms-sample" style="{margin:0 auto;}" data-toggle="validator" action="{{ route('superadmin.store.pengguna.mhs') }}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    {{ method_field('POST') }}
