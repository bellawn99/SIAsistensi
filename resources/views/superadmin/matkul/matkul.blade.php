...
@section('title')
	<a href="{{url('superadmin/master/matkul')}}" style="color:black; text-decoration:none">Master Matakuliah</a>
@endsection
                      ...
                      <tbody>
                        <tr>
                          @foreach ($matkuls as $item)
                            ...
                            <td>{{ $item->sks }}</td>
                            <td>
                            <a href="{{route('superadmin.master.editMatkul',$item['id'])}}">
...
<div class="modal fade" id="tambahMatkul" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="forms-sample" style="{margin:0 auto;}" data-toggle="validator" action="{{ route('superadmin.store.matkul') }}" method="post">
                    {{csrf_field()}}
                    {{ method_field('POST') }}
...
<div class="modal fade" id="importMatkul" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="{{ route('superadmin.import.matkul') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
