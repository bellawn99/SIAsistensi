...
@section('title')
	<a href="{{url('superadmin/praktikum')}}" style="color:black; text-decoration:none">Praktikum</a>
@endsection
                      ...
                      <tbody>
                        <tr>
                          @foreach ($praktikums as $index => $item)
                            ...
                            <a href="{{route('superadmin.edit.praktikum',$item['id'])}}">
...
<div class="modal fade" id="tambahPraktikum" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form class="forms-sample" style="{margin:0 auto;}" data-toggle="validator" action="{{ route('superadmin.store.praktikum') }}" method="post">
                    {{csrf_field()}}
                    {{ method_field('POST') }}
