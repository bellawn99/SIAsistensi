...
@section('title')
	<a href="{{url('superadmin/periode')}}" style="color:black; text-decoration:none">Periode</a>
@endsection
                      ...
                      <tbody>
                        <tr>
                          @foreach ($periodes as $item)
                            ...
                            <td>
                            <a href="{{route('superadmin.edit.periode',$item['berita_id'])}}">
...
<div class="modal fade" id="tambahPeriode" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="forms-sample" style="{margin:0 auto;}" data-toggle="validator" action="{{ route('superadmin.store.periode') }}" method="post">
                    {{csrf_field()}}
                    {{ method_field('POST') }}
