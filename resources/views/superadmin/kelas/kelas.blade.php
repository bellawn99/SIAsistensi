...
@section('title')
	<a href="{{url('superadmin/master/kelas')}}" style="color:black; text-decoration:none">Master Kelas</a>
@endsection
                      ...
                      <tbody>
                        <tr>
                          @foreach ($kelass as $item)
                            ...
                            <td>{{ $item->nama }}</td>  
                            <td>
                            <a href="{{route('superadmin.master.editKelas',$item['id'])}}">
...
<div class="modal fade" id="tambahKelas" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="forms-sample" style="{margin:0 auto;}" data-toggle="validator" action="{{ route('superadmin.store.kelas') }}" method="post">
                    {{csrf_field()}}
                    {{ method_field('POST') }}
...
<div class="modal fade" id="importKelas" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="{{ route('superadmin.import.kelas') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                    ...
                    <b>PENTING!</b><br><br>
                    <img src="{{url('assets/images/penjelasan/kelas.png')}}" width="100%"/><br>
                    <ol>
