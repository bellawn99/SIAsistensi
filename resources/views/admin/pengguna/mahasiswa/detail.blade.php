...
@section('title')
<a href="{{url('admin/pengguna/user-mahasiswa')}}" style="color:black; text-decoration:none">Mahasiswa</a> / <a style="color:grey; text-decoration:none">Detail Mahasiswa</a>
@endsection
